...
BOWER_ANGULAR_TRANSLATE_REV = '2.4.2'
BOWER_ANGULAR_TRANSLATE_ROOT_NAME = (
    'bower-angular-translate-%s' % BOWER_ANGULAR_TRANSLATE_REV)
BOWER_ANGULAR_TRANSLATE_ZIP_URL = (
    'https://github.com/angular-translate/bower-angular-translate/archive/%s.zip'
    % BOWER_ANGULAR_TRANSLATE_REV)
BOWER_ANGULAR_TRANSLATE_ZIP_ROOT_NAME = BOWER_ANGULAR_TRANSLATE_ROOT_NAME
BOWER_ANGULAR_TRANSLATE_TARGET_ROOT_NAME = BOWER_ANGULAR_TRANSLATE_ROOT_NAME

BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_REV = '2.7.2'
BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_ROOT_NAME = (
    'bower-angular-translate-loader-partial-%s' %
    BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_REV)
BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_ZIP_URL = (
    'https://github.com/angular-translate/bower-angular-translate-loader-partial/archive/%s.zip'
    % BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_REV)
...
download_and_unzip_files(
    BOWER_ANGULAR_TRANSLATE_ZIP_URL,
    THIRD_PARTY_STATIC_DIR,
    BOWER_ANGULAR_TRANSLATE_ZIP_ROOT_NAME,
    BOWER_ANGULAR_TRANSLATE_TARGET_ROOT_NAME)
download_and_unzip_files(
    BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_ZIP_URL,
    THIRD_PARTY_STATIC_DIR,
    BOWER_ANGULAR_TRANSLATE_LOADER_PARTIAL_ZIP_ROOT_NAME,
